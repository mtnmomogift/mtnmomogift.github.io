...
(function($) {
	...
	var imageSelect = new CustomSelect({
		elem: 'mtn-select--image', // id of the original select element
		containerClasses: ['mtn-select', 'mtn-select--image'],
		buttonClasses: [
			'mtn-btn--outlined',
			'outline-white-bg-black',
	...
	$('#mtn-select--image').change(function() {
		var url = $(this).val();
		window.open(url);
	});
	...
	$('#inpt_search').on('focus', function() {
		...
		$('.mtn-icon-search').css('visibility', 'hidden');
	});
	...
	$('#inpt_search').on('blur', function() {
		...
		$('.mtn-icon-search').css('visibility', 'visible');
	});

	//footer js
	new AccordionJS('mtn-footer__accordion');
	new CustomSelect({
		elem: 'mtn-select--image-footer',
		containerClasses: ['mtn-select', 'mtn-select--image'],
		buttonClasses: [
			'mtn-btn--outlined',
			'outline-white-bg-black',
	...
	$('#mtn-select--image-footer').change(function() {
		var url = $(this).val();
		window.open(url);
	});
})(jQuery);
